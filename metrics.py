...
def calc_similarity_gaze_change_distance(change_len1, change_len2, metric='histogram_intersection', nbins=20):
...
def calc_similarity_gaze_change_orientation(change_deg1, change_deg2, metric='histogram_intersection', nbins=8):
